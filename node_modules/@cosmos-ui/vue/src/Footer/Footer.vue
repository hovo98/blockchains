    ...
    <div class="grid">
      <div class="header">
        ...
        <div class="header__links" ref="links">
          ...
          <a @mouseover="linkMouseover(link, $event, true)" @mouseleave="linkMouseover(link, $event, false)" :href="url(link)" v-for="(link, index) in linksNew" :key="url(link)" class="header__links__item" target="_blank" >
            <svg v-if="index == 0" width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" class="header__links__item__image">
              <svg data-v-6c0fa742="" width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" class="header__links__item__image"><path data-v-6c0fa742="" d="M24 24h-24v-24h24v24zm-4.03-5.649v-.269l-1.247-1.224c-.11-.084-.165-.222-.142-.359v-8.998c-.023-.137.032-.275.142-.359l1.277-1.224v-.269h-4.422l-3.152 7.863-3.586-7.863h-4.638v.269l1.494 1.799c.146.133.221.327.201.523v7.072c.044.255-.037.516-.216.702l-1.681 2.038v.269h4.766v-.269l-1.681-2.038c-.181-.186-.266-.445-.232-.702v-6.116l4.183 9.125h.486l3.593-9.125v7.273c0 .194 0 .232-.127.359l-1.292 1.254v.269h6.274z" style="pointer-events: none;"></path></svg>
            </svg>

            <svg v-else-if="index == 4" data-v-6c0fa742="" width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"
                 clip-rule="evenodd" class="header__links__item__image">
              <path data-v-6c0fa742=""
            ...
            <svg v-else width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" class="header__links__item__image">
      ...
      <div class="menu">
        <div class="menu__item"  style="text-align: right">
          <div class="menu__item__title">Navigation</div>
          <div  class="menu__item__item">
            <router-link  tag="a" :to="{ name: 'index' }">Home</router-link>
          </div>
          <div  class="menu__item__item">
            <a href="https://dysonprotocol.com/documentation" target="_blank">Documenation</a>
          </div>
        </div>
      </div>
    </div>
...
export default {
  props: {
    ...
    linksNew: {
      type: Array,
      default: () => [
        { title: "Medium", url: "https://medium.com/@dysonprotocol" },
        { title: "Twitter", url: "https://twitter.com/DysonProtocol" },
        { title: "Reddit", url: "https://www.reddit.com/r/dysonprotocol/" },
        { title: "Telegram", url: "https://t.me/cosmosproject" },
        { title: "Discord", url: "https://discord.com/channels/940167079657615370/940167079657615373" },
      ]
    },
